...
function NavScrollExample() {
    return (
        <div className='News-letter-section app-bg-Dark mb-60'>
            <Container>
                <div className='row'>
                    <div className='col-md-8 offset-md-2 text-center'>
                        <div className='news-letter-box'>
                            <div className='Hero-Label'>
                                <p>No-code content to your inbox</p>
                            </div>
                            <h1 className='hero-title'>Join our community and claim free products</h1>
                            <p className='f-18 mt-28'>
